            ...
            <div>
              ...
              <div className="flex flex-col mt-4">
                <div className=" w-full rounded-xl bg-progress-background">
                  <div className=" w-[20%] h-2  bg-progress-green rounded-xl ">
                  </div>
                </div>
                <text className=" font-sans mx-auto mt-2 text-xs">20% Complete</text>
              </div>
                    {/* List items */}
              <div className="flex flex-col items-start w-[248px] h-[285px] mt-[14px] mb-[14px]">

                <ul className="font-Roboto text-sm  ">
                    <li className=" mb-6 text-blue-border font-bold">Day 1 | 7-Figure Math + AC Formula</li>
